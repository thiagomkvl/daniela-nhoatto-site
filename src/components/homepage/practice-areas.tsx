      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {practiceAreas.map((area) => (
            <Card key={area.title} className="text-center flex flex-col items-center border-t-4 border-t-primary shadow-lg hover:shadow-xl transition-shadow duration-300">
